                ...
                <div class="panel-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblIndexedPages" runat="server"></asp:Label></td>
                        </tr>
                        <tr>
                            <td>Indexed Urls
                            </td>
                            <td>
                                <asp:Label ID="lblIndexedFurls" runat="server"></asp:Label></td>
                        </tr>
                        <tr>
                            <td>Batch status
                            </td>
                            <td>
                                <asp:Literal runat="server" ID="ltlReindexStatus"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td>Url status
                            </td>
