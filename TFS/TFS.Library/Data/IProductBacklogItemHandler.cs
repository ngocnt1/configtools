...
{
    public interface IProductBacklogItemHandler
    {
        ProductBacklogItem GetProductBacklogItem(int id);
        System.Collections.Generic.IList<ProductBacklogItem> GetProductBacklogs(string tfsProject, string iterationPath);
        int CreateProductBacklogItem(ProductBacklogItem pbi);
    }
}
